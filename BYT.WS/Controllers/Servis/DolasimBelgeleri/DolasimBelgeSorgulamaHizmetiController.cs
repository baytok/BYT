...
namespace BYT.WS.Controllers.Servis.DolasimBelgeleri
{
    ...
    public class DolasimBelgeSorgulamaHizmetiController : ControllerBase
    {
        ...
        public DolasimBelgeSorgulamaHizmetiController(IslemTarihceDataContext islemTarihcecontext, BeyannameDataContext beyannameContex, IOptions<ServisCredential> servisCredential, IConfiguration configuration)
        {
