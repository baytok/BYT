...
@Component({
  ...
  templateUrl: './nctssonucservis.component.html',
  styleUrls: ['./nctssonucservis.component.scss']
  
})

export class NctsSonucServisComponent 
implements OnInit {
  step = 0;
  ngClass="";
  constructor(
    injector: Injector,
    public dialogRef: MatDialogRef<NctsSonucServisComponent>,
